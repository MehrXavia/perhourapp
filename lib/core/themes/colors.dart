...
class AppColors {
  ...
  static Color splashScreenBackgroundColor = const Color.fromRGBO(33, 33, 33, 1);
  static Color splashScreenTextColor = const Color.fromRGBO(255, 255, 255, 1);

  //Introduction pages Colors.
  static Color introPageBackgroundColor = const Color.fromRGBO(255, 255, 255, 1);
...
const kDark12= Color(0xff121212);
...
const kBlueColorE4 = Color(0xff2A60E4);
const kBlueColore7 = Color(0xff7799e7);

// not added yet to theme  ahh
...
const kBlackColor_12 = Color(0xff121212);
const kUnRatedColor = Color(0xffCDD4D9);
const kMainColor = Color(0xff2A60E4);
const kDropDown = Color(0xffCDD4D9);
const kColor = Color(0xffA0BCFF);
const kColor_77 = Color(0xffFFEACC);
